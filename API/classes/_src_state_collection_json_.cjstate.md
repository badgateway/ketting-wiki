[ketting](../README.md) › [Globals](../globals.md) › ["src/state/collection-json"](../modules/_src_state_collection_json_.md) › [CjState](_src_state_collection_json_.cjstate.md)
...
* [constructor](_src_state_collection_json_.cjstate.md#constructor)

### Properties

* [client](_src_state_collection_json_.cjstate.md#client)
* [data](_src_state_collection_json_.cjstate.md#data)
* [embedded](_src_state_collection_json_.cjstate.md#protected-embedded)
* [headers](_src_state_collection_json_.cjstate.md#headers)
* [links](_src_state_collection_json_.cjstate.md#links)
* [timestamp](_src_state_collection_json_.cjstate.md#timestamp)
* [uri](_src_state_collection_json_.cjstate.md#uri)

### Methods

* [action](_src_state_collection_json_.cjstate.md#action)
* [clone](_src_state_collection_json_.cjstate.md#clone)
* [contentHeaders](_src_state_collection_json_.cjstate.md#contentheaders)
* [getEmbedded](_src_state_collection_json_.cjstate.md#getembedded)
* [serializeBody](_src_state_collection_json_.cjstate.md#serializebody)

## Constructors

###  constructor

\+ **new CjState**(`uri`: string, `data`: T, `headers`: Headers, `links`: [Links](_src_link_.links.md), `embedded?`: [State](../interfaces/_src_state_interface_.state.md)[]): *[CjState](_src_state_collection_json_.cjstate.md)*
...
**Returns:** *[CjState](_src_state_collection_json_.cjstate.md)*
...
▸ **clone**(): *[CjState](_src_state_collection_json_.cjstate.md)‹T›*
...
*Defined in [src/state/collection-json.ts:15](https://github.com/evert/ketting/blob/f7a0a1b/src/state/collection-json.ts#L15)*

**Returns:** *[CjState](_src_state_collection_json_.cjstate.md)‹T›*
...
*Defined in [src/state/collection-json.ts:10](https://github.com/evert/ketting/blob/f7a0a1b/src/state/collection-json.ts#L10)*
